	...
	testCases := []struct {
	...
	}{
		{
			...
			buildContext: func(t *testing.T, tokenMaker token.Maker) context.Context {
				...
				return newContextWithBearerToken(t, tokenMaker, user.Username, "depositor", time.Minute)
			},
			checkResponse: func(t *testing.T, res *pb.UpdateUserResponse, err error) {
		...
		// 		return newContextWithBearerToken(t, tokenMaker, banker.Username, "banker", time.Minute)
		// 	},
		// 	checkResponse: func(t *testing.T, res *pb.UpdateUserResponse, err error) {
		// 		require.NoError(t, err)
		// 		require.NotNil(t, res)
		...
		// },
		{
			...
			buildContext: func(t *testing.T, tokenMaker token.Maker) context.Context {
				...
				return newContextWithBearerToken(t, tokenMaker, other.Username, "depositor", time.Minute)
			},
			checkResponse: func(t *testing.T, res *pb.UpdateUserResponse, err error) {
				require.Error(t, err)
